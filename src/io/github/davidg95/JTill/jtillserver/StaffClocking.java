    ...
    public void setTable() {
        ...
        for (ClockItem item : currentTableContents) {
            ...
            if (item.getType() == ClockItem.CLOCK_ON) {
                row = new Object[]{item.getTime(), "ON"};
            } else {
                row = new Object[]{item.getTime(), "OFF"};
            }
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtStaff, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
